...
* 每个部落初始拥有 15 人口。
* 双方同时秘密选择本轮行动：有手牌时打出 1 张卡牌；没有手牌时发动「垂死一搏」。使用后的牌进入各自的弃牌堆。
...
当玩家在选择行动时没有任何手牌，必须发动「垂死一搏」。

发动时，秘密选择投入 **1～3 人口**，且投入数量不能超过己方当前人口。双方选择完行动后，同时公开。

结算时，己方部落失去所投入的人口，并对敌方部落造成等量的人口伤害。

「垂死一搏」不视为卡牌，不会进入弃牌堆，也不能被「守夜」抵消。它与对方本轮打出的卡牌或发动的「垂死一搏」同时结算。

如果结算后双方人口同时降至 0，则本局为平局；只有一方人口降至 0 时，该方被击败。
