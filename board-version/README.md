...
游戏开始时，每个部落拥有 **12 人口**。玩家使用人口标记、计数器或纸笔记录当前人口。
...
1. **如果双方均没有手牌**，则立即比较双方剩余人口以决定胜负（见下方「比较胜负」）。
2. **如果只有一方没有手牌**，则本轮为最后一轮。没有手牌的玩家发动「垂死一搏」，仍有手牌的玩家正常打出一张卡牌。
3. **最后一轮结算完成后**，如果双方均未被击败，则比较双方剩余人口以决定胜负（见下方「比较胜负」）。
...
如果本轮对方打出「夜袭」或「劫掠」，使其效果无效，再对敌方部落造成 1 点人口伤害。
